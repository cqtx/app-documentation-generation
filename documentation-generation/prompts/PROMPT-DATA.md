...
Create a notes file at `../output/_notes/{ProjectName}/DATA.notes.md` and build it
...
2. Immediately append notes for that file to `../output/_notes/{ProjectName}/DATA.notes.md`
