...
Create a notes file at `../output/_notes/{ProjectName}/API.notes.md` and build it
...
2. Immediately append notes for that handler to `../output/_notes/{ProjectName}/API.notes.md`
